...
public class WaterRespawnZone : MonoBehaviour
{
    ...
    private void RespawnVehicle(DrivableVehicle vehicle)
    {
        ...
        {
            InteractionPromptHUD.Instance.ShowPrompt(LocalizationManager.Get("prompt_water_rescue_vehicle"));
        }
    ...
    private void RespawnPlayer(FPSPlayerController player)
    {
        ...
        if (InteractionPromptHUD.Instance != null)
        {
            InteractionPromptHUD.Instance.ShowPrompt(LocalizationManager.Get("prompt_water_rescue_player"));
        }
    }
